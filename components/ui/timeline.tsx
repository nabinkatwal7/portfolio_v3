...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      className="w-full flex flex-col justify-center content-center max-w-[1350px] mx-auto"
      ref={containerRef}
    >
      ...
      <div
        ref={ref}
        className="relative flex flex-col justify-center content-center  mx-auto pb-32"
      >
        {data.map((item, index) => (
          <div
            key={index}
