...
import { HiBars3, HiFilm, HiHome, HiNewspaper, HiRectangleStack, HiUserCircle, HiXMark } from "react-icons/hi2";
        ...
        <>
            ...
            >
                <nav className="mx-auto flex items-center justify-between p-4">
                    <Link href="/" className="text-2xl font-[var(--font-Logo)] font-bold text-[var(--color-primary)]">
                        Nabin Katwal
                    </Link>
