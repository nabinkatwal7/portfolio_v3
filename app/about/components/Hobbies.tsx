...
import { RibbonBackground } from "@/components/common/animation/RibbonBackground";
...
const hobbies = [
  {
    name: "Travel.",
    description:
      "Exploring new places, trying local foods, and collecting memories.",
    image: "/hobbies/travel.jpg",
  },
  {
    name: "Movies.",
    description:
      "Big screen, small screen, doesn't matter?if its got a great story, Im in?",
  ...
  },
  {
    ...
    description: "Whether it's an open-world RPG or a weekend soccer match.",
    image: "/hobbies/games.jpg",
  },
  {
    name: "Music.",
    description: "A playlist for every mood? coding, gaming, or just vibing.",
    ...
    <div className="relative overflow-hidden">
      ...
      <div className="common-layout max-w-[1350px] py-24">
        ...
        >
          <motion.div
            variants={slideUp}
            className="mx-auto text-center flex flex-col items-center mb-8"
          >
            <p className="text-label mb-2 opacity-50 uppercase tracking-[0.2em]">
              My Passions
            </p>
            ...
            <p className="mt-8 text-body text-lg md:text-xl max-w-3xl text-[var(--color-text-main)]/70">
              ...
              universe, you&apos;ll find me diving into new tech and exploring
              my passions. Because life isn&apos;t all about semicolons and pull
              requests!
            </p>
          </motion.div>
            ...
            {hobbies.map((feature) => (
              ...
              >
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <dd className="text-body text-base text-[var(--color-text-main)]/70 leading-relaxed">
                    {feature.description}
                  </dd>
                </div>
              </motion.div>
