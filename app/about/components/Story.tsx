"use client";
import { MeshGradientBackground } from "@/components/common/animation/MeshGradientBackground";
import {
  slideInLeft,
  slideInRight,
  slideUp,
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      >
        <motion.p
          variants={slideUp}
          className="text-label mb-4 opacity-50 uppercase tracking-[0.2em]"
        >
          The Context
        </motion.p>
        <motion.h2
        ...
        <div className="mt-16 text-body text-left space-y-12">
          <motion.p
            ...
            className="text-lg md:text-xl leading-relaxed text-[var(--color-text-main)]/80"
          >
            You know me, right? By day, I&apos;m crafting sleek,
            high-performance Next.js, React, and Tailwind CSS applications sleek
            enough to make your grandmother think it&apos;s magic. By night?
            I&apos;m all about Go, TypeScript, and Rust.
          </motion.p>

          <motion.div
            variants={slideUp}
            className="max-w-3xl text-body text-left"
          >
            ...
            <ul role="list" className="mt-16 space-y-12">
              ...
              <motion.li variants={slideUp} className="flex gap-x-6 group">
                ...
                <span className="text-body text-lg md:text-xl font-medium leading-relaxed">
                  ...
                  thousands of requests, I keep things clean, efficient, and
                  blazing fast.
                </span>
              </motion.li>
            </ul>
            ...
            <motion.div
              variants={slideUp}
              className="mt-24 pt-12 border-t border-[var(--color-primary)]/10"
            >
              <h2 className="heading-card text-3xl mb-6">
                Lets Make Something Epic
              </h2>
              <p className="text-body text-lg md:text-xl text-[var(--color-text-main)]/70">
                ...
                Well, I&apos;m your guy. Let&apos;s work together and build
                something amazing.
              </p>
            </motion.div>
          </motion.div>
